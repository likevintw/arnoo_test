...
def specific_threshold(value=0.7):
    ...
    run_accuracy_threshold_test(
        ...
        image_url_list_path="image_url_list_20210826/Vehicle_positive_path_list.txt",
        threshold=threshold,
        monitor=True)
    # Package
    run_accuracy_threshold_test(
        ...
        image_url_list_path="image_url_list_20210826/Package_positive_path_list.txt",
        threshold=threshold,
        monitor=True)
    # Human
    run_accuracy_threshold_test(
        ...
        image_url_list_path="image_url_list_20210826/Human_positive_path_list.txt",
        threshold=threshold,
        monitor=True)
    # Pet
    run_accuracy_threshold_test(
        ...
        image_url_list_path="image_url_list_20210826/Pet_positive_path_list.txt",
        threshold=threshold,
        monitor=True)
...
if __name__ == '__main__':
    ...
    #     project_name="vehicle_positive",
    #     image_url_list_path="image_url_list_20210826/Vehicle_positive_path_list.txt",
    #     threshold={"human": 0, "pet": 0, "vehicle": 0, "package": 0},
    #     monitor=True)
    # run_accuracy_threshold_test(
    #     algorithm_name="vehicle",
    #     project_name="vehicle_positive",
    #     image_url_list_path="image_url_list_20210826/Vehicle_positive_path_list.txt",
    #     threshold={"human": 1, "pet": 1, "vehicle": 1, "package": 1},
    #     monitor=True)
